...
INSERT INTO HOSTS (host_id, url, name, host_path, registry_flag, CREATED_DATE, MODIFIED_DATE) VALUES
  (2, '192.168.99.106', 'master-node', '/Users/denis/.docker/machine/machines/master-node', FALSE, SYSDATE, SYSDATE);
INSERT INTO HOSTS (host_id, url, name, host_path, registry_flag, CREATED_DATE, MODIFIED_DATE) VALUES
  (3, '192.168.99.107', 'slave-node-1', '/Users/denis/.docker/machine/machines/slave-node-1', FALSE, SYSDATE, SYSDATE);
...
INSERT INTO rel_environments_hosts (environment_id, host_id) VALUES (0, 2);
